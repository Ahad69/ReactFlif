  ...
  return (
    <>
      <section className="about-page section-b-space">
        <Container>
          <Row>
            ...
            <Col sm="12">
              <h4>
                Start your business with flif & reach customers across the
                World...
              </h4>
              <p className="mb-0">
      ...
      <section className="section-b-space become-vendor">
        <Container>
          <h4>doing business on flif is really easy</h4>
          ...
          <Col>
            <div>
              ...
              <p>
                ...
                and convenient seller portal, flif focuses on educating and
                empowering sellers across India. Selling on flif.com is
